...
echo.
echo 📊 CÁCH DEMO:
echo - Mỗi client login sẽ được route đến server khác nhau (Round-robin)
echo - Client 1 → Server1, Client 2 → Server2, Client 3 → Server1
echo - Xem Load Balancer console để theo dõi routing
echo - Clients có thể chat với nhau qua các server khác nhau
echo - Tất cả đều dùng TCP Socket thật!
echo.
pause
